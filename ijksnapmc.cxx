...
/*
  ...
  Copyright (C) 2008, 2011 Rephael Wenger
...
using IJKTIMEVAR::compute_iso_vertex_increment;
using IJKTIMEVAR::compute_nep_iso_vertex_increment;
using IJKTIMEVAR::compute_ivol_vertex_increment;
using IJKTIMEVAR::get_num_iso_vertices_per_grid_vertex;
using IJKTIMEVAR::get_num_ivol_vertices_per_grid_vertex;
using IJKTIMEVAR::get_num_nep_iso_vertices_per_grid_vertex;
using IJKTIMEVAR::check_nep;
using IJKTIMEVAR::check_isotable_encoding;
using IJKTIMEVAR::clock2seconds;

using IJKTIMEVAR::NEP;
using IJKTIMEVAR::BINARY;
using IJKTIMEVAR::IVOL;
 ...
 MC_ISOSURFACE & mc_isosurface, SNAP_INFO & snap_info)
{
  ...
  IJKTIMEVAR::NEP_ISO_MERGE_DATA merge_data(dimension, axis_size);
  clock_t t1 = clock();
