...
// **************************************************
  ...
  using IJKTIMEVAR::SCALAR_TYPE;
  using IJKTIMEVAR::COORD_TYPE;
  using IJKTIMEVAR::GRID_COORD_TYPE;
  using IJKTIMEVAR::TABLE_INDEX;
  using IJKTIMEVAR::AXIS_SIZE_TYPE;
  using IJKTIMEVAR::VERTEX_INDEX;
  using IJKTIMEVAR::EDGE_INDEX;
  using IJKTIMEVAR::MERGE_INDEX;
  using IJKTIMEVAR::ISO_VERTEX_INDEX;
  using IJKTIMEVAR::ISOTABLE_TYPE;
  using IJKTIMEVAR::MC_SCALAR_GRID_BASE;
  using IJKTIMEVAR::NEP_ISOSURFACE_TABLE;
  using IJKTIMEVAR::MERGE_DATA;
  using IJKTIMEVAR::MC_DATA;
  using IJKTIMEVAR::MC_ISOSURFACE;
  using IJKTIMEVAR::MINMAX_REGIONS;
  using IJKTIMEVAR::SNAP_TYPE;
  using IJKTIMEVAR::SNAP_OCTREE;
  using IJKTIMEVAR::SNAP_MINMAX;
...
// **************************************************
  ...
  void snap_scalar_values
    (const MC_SCALAR_GRID_BASE & scalar_grid, const SCALAR_TYPE isovalue, 
     ...
     VERTEX_INDEX * snap_back, const IJKTIMEVAR::MINMAX_REGIONS & minmax);
...
// **************************************************
  ...
  protected:
    ...
    void Create
      (const MC_SCALAR_GRID_BASE & scalar_grid, const SCALAR_TYPE isovalue, 
       const SNAP_TYPE snap_value, const IJKTIMEVAR::MINMAX_REGIONS & minmax);
    void Create
      (const MC_SCALAR_GRID_BASE & scalar_grid, const SCALAR_TYPE isovalue, 
...
// **************************************************
  ...
  /// Snap information.
  class SNAP_INFO:public IJKTIMEVAR::MCUBE_INFO {
  public:
