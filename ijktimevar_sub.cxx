...
void IJKTIMEVAR::merge_and_position_vertices
...
void IJKTIMEVAR::merge_identical_edges
...
void IJKTIMEVAR::set_in_facet_iso_patches(NEP_ISOSURFACE_TABLE & isotable)
{
...
void IJKTIMEVAR::position_iso_vertices_linear
(const MC_SCALAR_GRID_BASE & scalar_grid, const SCALAR_TYPE isovalue,
 const ISOTABLE_TYPE isotable_type,
 const std::vector<ISO_VERTEX_INDEX> & vlist, COORD_TYPE * coord)
// compute position of isosurface vertices using linear interpolation
...
void IJKTIMEVAR::position_iso_vertices_linearB
(const MC_SCALAR_GRID_BASE & scalar_grid, const SCALAR_TYPE isovalue,
 const ISOTABLE_TYPE isotable_type,
 const std::vector<VERTEX_INDEX> & elist, COORD_TYPE * coord)
// Compute position of isosurface vertices using linear interpolation
...
void IJKTIMEVAR::position_iso_vertices_multilinear
(const MC_SCALAR_GRID_BASE & scalar_grid, const SCALAR_TYPE isovalue,
 const ISOTABLE_TYPE isotable_type,
 const MC_MESH_VERTEX_LIST & new_mesh_vertices,
 const std::vector<VERTEX_INDEX> & elist, COORD_TYPE * coord)
...
void IJKTIMEVAR::convert_indices_to_endpoint_pairs
...
void IJKTIMEVAR::position_ivol_vertices_linear
(const MC_SCALAR_GRID_BASE & scalar_grid,
