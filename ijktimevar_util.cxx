...
void IJKTIMEVAR::compute_iso_vertex_increment
...
{
  PROCEDURE_ERROR error("IJKTIMEVAR::compute_iso_vertex_increment");
...
void IJKTIMEVAR::compute_iso_endpoint_increment
(const ISOSURFACE_TABLE & isotable, const VERTEX_INDEX * vertex_increment,
 VERTEX_INDEX * increment)
  // compute increment to add to primary vertex to get index 
...
{
  PROCEDURE_ERROR error("IJKTIMEVAR::compute_iso_endpoint_increment");
...
void IJKTIMEVAR::compute_nep_iso_vertex_increment
(const ISOSURFACE_TABLE & isotable, const VERTEX_INDEX * vertex_increment,
 VERTEX_INDEX * increment)
  // compute increment to add to primary vertex to get index 
  //   of isosurface vertex i of hypercube
  ...
  //               isotable.NumIsosurfaceVertices()
{
  PROCEDURE_ERROR error("IJKTIMEVAR::compute_nep_iso_vertex_increment");
...
void IJKTIMEVAR::compute_ivol_vertex_increment
(const ISOSURFACE_TABLE & isotable, const VERTEX_INDEX * vertex_increment,
 ISO_VERTEX_INDEX * increment)
  ...
  //               isotable.NumIsosurfaceVertices()
{
  PROCEDURE_ERROR error("IJKTIMEVAR::compute_ivol_vertex_increment");
...
void IJKTIMEVAR::compute_hypercube_edge_increment
...
void IJKTIMEVAR::compute_facet_increment
...
void IJKTIMEVAR::compute_facet_vertex_increment
...
void IJKTIMEVAR::get_mixed_cubes
...
std::string IJKTIMEVAR::get_isotable_filename
...
std::string IJKTIMEVAR::get_topology_string
...
bool IJKTIMEVAR::check_nep_num_dup(const int nep_num_dup, ERROR & error)
{
...
bool IJKTIMEVAR::check_order(const std::vector<VERTEX_INDEX> & endpoint,
                           ERROR & error)
{
...
bool IJKTIMEVAR::check_isotable_encoding
...
bool IJKTIMEVAR::check_isotable_ambig_info
(const ISOSURFACE_TABLE & isotable, 
...
bool IJKTIMEVAR::check_cube_isotable_fits_topology
...
bool IJKTIMEVAR::check_dimension
