...
namespace {
    ...
    // dimension = grid dimension
  {
    ...
    for (unsigned int i = 0; i < io_info.high_resolution_regions.size(); i++) {
...
void IJKTIMEVAR::parse_command_line(int argc, char **argv, IO_INFO & io_info)
  // parse command line
...
void IJKTIMEVAR::read_nrrd_file
(const char * input_filename, MC_SCALAR_GRID & scalar_grid, IO_INFO & io_info,
 IO_TIME & io_time)
{
...
void IJKTIMEVAR::read_cube_isotable
 ...
 ISOSURFACE_TABLE & cube_isotable, IO_TIME & io_time)
{
  read_isosurface_table
    (dimension, "cube", isotable_type, isotable_directory, 
     cube_isotable, io_time);
}

/// Read polytope isosurface lookup table.
void IJKTIMEVAR::read_poly_isotable
...
void IJKTIMEVAR::read_isosurface_table_from_file
 ...
 ISOSURFACE_TABLE & isotable, const int nrrd_dimension)
{
  string isotable_pathname = 
    isotable_directory + PATH_DELIMITER + isotable_filename;
...
void IJKTIMEVAR::read_isosurface_table
...
ISOTABLE_TYPE IJKTIMEVAR::get_isotable_type(const MC_DATA & mc_data)
{
...
void IJKTIMEVAR::get_isotable_directory(std::string & isotable_directory)
{
...
void IJKTIMEVAR::output_isosurface
...
void IJKTIMEVAR::output_nep_isosurface
(const OUTPUT_INFO & output_info, const MC_DATA & mc_data,
 const MC_ISOSURFACE & mc_isosurface,
 const MCUBE_INFO & mcube_info, IO_TIME & io_time)
{
...
void IJKTIMEVAR::output_snapmc_isosurface
(const OUTPUT_INFO & output_info, const MC_DATA & mc_data,
 const MC_ISOSURFACE & mc_isosurface,
...
void IJKTIMEVAR::output_isosurface_color
(const OUTPUT_INFO & output_info, const MC_DATA & mc_data,
 const MC_ISOSURFACE & mc_isosurface,
...
void IJKTIMEVAR::output_isosurface_color_alternating
(const OUTPUT_INFO & output_info, const MC_DATA & mc_data,
 const MC_ISOSURFACE & mc_isosurface,
 const MCUBE_INFO & mcube_info, IO_TIME & io_time)
{
  ...
  case IV:
    if (dimension == 3) {
      if (!use_stdout) {
        ...
        ijkoutIV(dimension, vertex_coord, slist);
      }
    }
...
void IJKTIMEVAR::write_mesh_color
(const OUTPUT_INFO & output_info,
 const vector<COORD_TYPE> & vertex_coord, const vector<VERTEX_INDEX> & slist,
 const COLOR_TYPE * front_color, const COLOR_TYPE * back_color)
{
...
void IJKTIMEVAR::rescale_vertex_coord
...
void IJKTIMEVAR::report_num_cubes
...
void IJKTIMEVAR::report_iso_info
(const OUTPUT_INFO & output_info, const MC_DATA & mc_data,
...
void IJKTIMEVAR::report_nep_info
(const OUTPUT_INFO & output_info, const MC_DATA & mc_data,
 const vector<COORD_TYPE> & vertex_coord, 
 const vector<VERTEX_INDEX> & slist, 
 const MCUBE_INFO & mcube_info)
...
void IJKTIMEVAR::report_snap_info
(const OUTPUT_INFO & output_info, const MC_DATA & mc_data,
 const vector<COORD_TYPE> & vertex_coord, 
 const vector<VERTEX_INDEX> & slist, 
...
void IJKTIMEVAR::report_mcube_time
...
void IJKTIMEVAR::OUTPUT_INFO::Init()
{
  output_filename = "";
  dimension = 3;
...
void IJKTIMEVAR::set_output_info
...
void IJKTIMEVAR::set_color_alternating
